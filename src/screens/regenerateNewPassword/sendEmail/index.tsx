    ...
    <div className=' bg-BrandGreenLight min-h-screen flex flex-col'>
      ...
      {loading ?
          ...
          <form
            ...
            <h1 className=' text-titleM text-BaseGray100 font-nunito text-center mb-8 '>Esqueceu a senha?</h1>
            <p className=' text-BaseGray200 text-bodyM font-nunito mb-8'>Abaixo, você irá informar o seu e-mail cadastrado para que possamos lhe enviar o próximo passo
              para redefinir sua senha. Por favor, verifique seu e-mail para redefinir sua senha!
            </p>
            <div className='flex flex-col gap-2 w-full'>
              <label htmlFor="" className=' text-titleXS font-nunito text-BaseGray200'>Email de acesso</label>
              <input
                className={`w-full mb-4 px-2 py-4 rounded-lg ${errors.email ? " bg-BrandRedLight" : "bg-BaseGray500"} text-bodyM text-BaseGray200 font-nunito outline-none placeholder:text-BaseGray400`}
                type="text"
