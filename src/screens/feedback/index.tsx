    ...
    <div className=" w-full text-center min-h-screen flex py-8">
      <main className=" w-full px-8 flex flex-col items-center m-auto">
        <div className="flex flex-col gap-2">
          <h2
            className={`text-titleM font-nunito ${
              status === "true" ? "text-BrandGreenDark" : "text-BrandRedDark"
            }`}
          >
        ...
        <div>
          <img
            className={`mt-10 mb-8 ${
              status === "true" ? "animate-bounce" : "animate-pulse"
            }`}
            src={status === "true" ? illustrationTrue : illustrationFalse}
            alt=""
          />
        </div>
        <Link to={"/home"} className=" active-solid-button ">
