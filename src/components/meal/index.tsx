...
export function Meal({id, name, hour, isDiet}:IMelsProps) {
  return (
    <Link to={`/meal/${id}`} className="flex gap-3 items-center py-4 px-3 w-full border border-BaseGray500 rounded-md">
